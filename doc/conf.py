...
sys.path.append(os.path.join(os.path.abspath(os.pardir),'oocgcm'))
...
project = u'oocgcm'
copyright = u'2016, oocgcm developpers'
...
latex_documents = [
  ('index', 'oocgcm.tex', u'oocgcm Documentation',
   u'oocgcm developpers', 'manual'),
]
...
man_pages = [
    ('index', 'oocgcm', u'oocgcm Documentation',
     [u'oocgcm developpers'], 1)
]
...
texinfo_documents = [
  ('index', 'oocgcm', u'oocgcm Documentation',
   u'oocgcm developpers', 'oocgcm', 'One line description of project.',
   'Miscellaneous'),
]
